        ...
        try {
            ...
            try (InputStream inputStream = resource.getInputStream()) {
                ...
                for (JsonNode regionNode : regionsNode) {
                    ...
                    // NO agregar provincias a la colección de la región antes del save.
                    // JPA con IDs asignados usa merge() y falla si las asociaciones
                    // no están persistidas aún.
                }

                // Guardar en orden estricto: regiones → provincias → comunas
